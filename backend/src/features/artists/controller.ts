...
export const getArtistArtworks = asyncHandler(async (req: Request, res: Response) => {
  const { slug } = req.params;
...
export const getArtistExhibitions = asyncHandler(async (req: Request, res: Response) => {
  const { slug } = req.params;
...
export const getArtistPublications = asyncHandler(async (req: Request, res: Response) => {
  const { slug } = req.params;
...
export const updateArtistProfile = asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
  const userId = req.user!.id;

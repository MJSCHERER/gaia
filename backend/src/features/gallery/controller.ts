...
export const getFeaturedArtworks = asyncHandler(async (req: Request, res: Response) => {
...
export const getArtistsPreview = asyncHandler(async (req: Request, res: Response) => {
